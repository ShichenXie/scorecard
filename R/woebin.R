...
#' bins2 <- woebin(dt2, y = "creditability",
...
#' )
#'
#' bins_c <- woebin(dt2, y="creditability", breaks_list=breaks_list)
#' }
#'
#' @import data.table
...
#' bins_germ <- woebin(germancredit, y="creditability")
#'
#' # converting the values of germancredit to woe
#' germancredit_woe <- woebin_ply(germancredit, bins_germ)
#' }
#'
#' @import data.table
#' @export
...
#' data(germancredit)
#'
#' dt <- germancredit[, c("creditability", "credit.amount")]
#'
#' # binning
#' bins1 <- woebin(dt, y="creditability")
#'
#' # binning plot
#' woebin_plot(bins1)
#'
